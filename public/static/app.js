...
class WorVox {
  constructor() {
    ...
    // Scenario Mode Data - Loaded from scenario-data.js module
    this.scenarios = window.WORVOX_SCENARIOS || [];
...
Proceed to payment?
    ...
    if (confirmed) {
      // FUTURE: Hiing payment integration
      // Issue: Payment gateway needs to be integrated
      // Current: Booking details are logged only
      toast.info('💳 결제 기능 준비 중입니다! 예약 정보가 저장되었습니다.');
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        <div class="flex items-center gap-2">
                          ...
                          <span class="bg-emerald-600 text-white text-xs px-2 py-0.5 rounded-full font-bold">추천</span>
                        </div>
                        <p class="text-xs md:text-sm text-gray-300">AI와 자유 대화 (초급~고급)</p>
                      </div>
                    </div>
                    <div class="text-xs text-gray-400">~5분</div>
                  </div>
                  <button onclick="worvox.showAIConversation()" class="w-full bg-gray-700 dark:bg-gray-700 text-white font-bold py-3 rounded-lg hover:bg-gray-600 transition-all text-sm md:text-base shadow-lg">
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        <div class="flex items-center gap-2">
                          ...
                          ${this.userPlan === 'free' ? '<span class="bg-orange-600 text-white text-xs px-2 py-0.5 rounded-full font-bold">1회/일</span>' : ''}
                        </div>
                        <p class="text-xs md:text-sm text-gray-300">제한 시간 안에 빠르게 말하기</p>
                      </div>
                    </div>
                    <div class="text-xs text-gray-400">~3분</div>
                  </div>
                  <button onclick="worvox.showTimerMode()" class="w-full bg-gray-700 dark:bg-gray-700 text-white font-bold py-3 rounded-lg hover:bg-gray-600 transition-all text-sm md:text-base shadow-lg">
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        <div class="flex items-center gap-2">
                          ...
                          ${this.userPlan === 'free' ? '<span class="bg-purple-600 text-white text-xs px-2 py-0.5 rounded-full font-bold">1회/일</span>' : ''}
                        </div>
                        <p class="text-xs md:text-sm text-gray-300">실전 상황 롤플레잉 연습</p>
                      </div>
                    </div>
                    <div class="text-xs text-gray-400">~10분</div>
                  </div>
                  <button onclick="worvox.showScenarioMode()" class="w-full bg-gray-700 dark:bg-gray-700 text-white font-bold py-3 rounded-lg hover:bg-gray-600 transition-all text-sm md:text-base shadow-lg">
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        <div class="flex items-center gap-2">
                          ...
                          ${this.userPlan === 'free' ? '<span class="bg-blue-600 text-white text-xs px-2 py-0.5 rounded-full font-bold">1회/일</span>' : ''}
                        </div>
                        <p class="text-xs md:text-sm text-gray-300">영어 실력 테스트 및 평가</p>
                      </div>
                    </div>
                    <div class="text-xs text-gray-400">~15분</div>
                  </div>
                  <button onclick="worvox.showExamMode()" class="w-full bg-gray-700 dark:bg-gray-700 text-white font-bold py-3 rounded-lg hover:bg-gray-600 transition-all text-sm md:text-base shadow-lg">
                    <i class="fas fa-file-alt mr-2"></i>지금 시작하기
                  </button>
                </div>
                
                <!-- 5. 단어 학습 -->
                <div class="bg-gray-800 dark:bg-gray-800/90 rounded-2xl p-5 md:p-6 mb-4 text-white shadow-lg border-2 border-green-600 dark:border-green-500">
                  <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-3">
                      <div class="text-2xl">📖</div>
                      <div>
                        ...
                        <p class="text-xs md:text-sm text-gray-300">필수 영단어 암기 및 복습</p>
                      </div>
                    </div>
                    <div class="text-xs text-gray-400">~5분</div>
                  </div>
                  <button onclick="worvox.startVocabulary()" class="w-full bg-gray-700 dark:bg-gray-700 text-white font-bold py-3 rounded-lg hover:bg-gray-600 transition-all text-sm md:text-base shadow-lg">
                    <i class="fas fa-book mr-2"></i>지금 시작하기
                  </button>
                </div>
                
                <!-- 6. 실시간 튜터 수업 -->
                <div class="bg-gray-800 dark:bg-gray-800/90 rounded-2xl p-5 md:p-6 mb-5 text-white shadow-lg border-2 border-pink-600 dark:border-pink-500">
                  <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-3">
                      <div class="text-2xl">👨‍🏫</div>
                      <div>
                  ...
                  <button onclick="worvox.showRealConversation()" class="w-full bg-gray-700 dark:bg-gray-700 text-white font-bold py-3 rounded-lg hover:bg-gray-600 transition-all text-sm md:text-base shadow-lg">
                    <i class="fas fa-video mr-2"></i>지금 시작하기
                  </button>
                </div>
  ...
  async updateProfile() {
    ...
    try {
      ...
      if (username !== this.currentUser.username) {
        // FUTURE: Username update endpoint
        // Issue: Backend endpoint /api/users/:id/username not yet implemented
        // Current: Updates locally in localStorage only
        this.currentUser.username = username;
        console.log('⚠️ Username updated locally only (backend endpoint pending)');
      }
