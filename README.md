...
- ✅ **다시 듣기 버튼**: AI 응답을 다시 들을 수 있는 재생 버튼 🆕
- ✅ **학습 히스토리**: 날짜별 세션 목록 및 전체 대화 내용 조회
  - 🔊 **히스토리 다시 듣기**: 과거 대화의 AI 응답도 다시 들을 수 있음 🆕
- ✅ **학습 통계 대시보드**: 
  - 📊 일별 활동 차트 (최근 30일)
  - 🎯 주제별 학습 분포 (도넛 차트)
  - 📅 주간 진행률 (최근 12주)
...
- ✅ **단어 학습 기능** (Vocabulary): **🌟 FULLY UPGRADED!**
  ...
  - 📖 **678개 단어**: beginner(157개), intermediate(270개), advanced(251개)
  - 🏆 **TOEIC 단어**: 545개 (약 80%)에 'TOEIC' 라벨 표시
  - 📘 **TOEFL 단어**: 362개 (약 53%)에 'TOEFL' 라벨 표시
  - 🎓 **TOEIC & TOEFL 중복**: 325개 단어는 두 라벨 모두 표시
...
### 최근 업데이트
- **2026-02-11**: 🔊 **히스토리 다시 듣기 추가** - 과거 대화의 AI 응답도 다시 들을 수 있음
- **2026-02-11**: 🕐 **시간대 수정** - 모든 타임스탬프를 한국 표준시(KST, UTC+9)로 저장
- **2026-02-11**: 🔊 **AI 응답 다시 듣기 버튼 추가** - 대화 중 AI 응답을 언제든지 다시 들을 수 있음
- **2026-02-11**: 🆕 **Quiz 모드 개선** - "Next Quiz" 버튼으로 새로운 단어 세트 학습
